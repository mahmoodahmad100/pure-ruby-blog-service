...
ActiveRecord::Schema[7.0].define(version: 20_220_831_070_606) do
  create_table 'feedbacks', charset: 'utf8mb4', force: :cascade do |t|
    ...
    t.index %w[feedbackable_type feedbackable_id], name: 'index_feedbacks_on_feedbackable'
  ...
  create_table 'posts', charset: 'utf8mb4', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[user_id title], name: 'index_posts_on_user_id_and_title'
